...
const Hero = ({ onStartChatting }: HeroProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-brightGray/80 mb-12 max-w-2xl mx-auto leading-relaxed">
            Finally, mental health support designed for Gen Z. No judgment, no waiting lists, no
            awkward small talk. Just real conversations that help.
          </p>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  size="lg"
                  className="border-carolinaBlue/50 !text-brightGray hover:bg-carolinaBlue/10 text-lg px-8 py-4 h-auto font-semibold"
                >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 bg-carolinaBlue/10 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-chineseBlack/70">
                          No signup forms, no questionnaires. Just type what's on your mind and hit
                          send. Our AI therapist is ready to listen and help.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-carolinaBlue/10 rounded-lg">
                      ...
                      <div>
                        <h3 className="font-semibold text-chineseBlack mb-2">
                          Get Empathetic Responses
                        </h3>
                        <p className="text-chineseBlack/70">
                          Our AI understands Gen Z language, slang, and the unique challenges you
                          face. It responds with empathy, not judgment.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-carolinaBlue/20 to-brightGray/20 p-6 rounded-lg border border-carolinaBlue/30">
                    ...
                    <div className="bg-carolinaBlue/10 p-4 rounded-lg border border-carolinaBlue/30">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-semibold text-chineseBlack">
                          Crisis Support - NIMHANS
                        </h4>
                      </div>
                      <a
                        href="tel:8277946600"
                      ...
                      <p className="text-chineseBlack/70 text-sm mt-2">
                        Connect with trained mental health professionals at NIMHANS (National
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-brightGray mb-2">Gen Z</div>
              <div className="text-brightGray/70">Focussed</div>
            </div>
            <div className="text-center">
      ...
      {/* Floating elements */}
      <div
        className="absolute top-20 left-20 w-20 h-20 bg-carolinaBlue/20 rounded-full animate-bounce"
        style={{ animationDelay: '0s' }}
      />
      <div
        className="absolute bottom-32 right-32 w-16 h-16 bg-carolinaBlue/20 rounded-full animate-bounce"
        style={{ animationDelay: '1s' }}
      />
      <div
        className="absolute top-1/2 right-20 w-12 h-12 bg-carolinaBlue/20 rounded-full animate-bounce"
