    ...
    <div className="py-20 bg-brightGray/30">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <Card
            className="border border-carolinaBlue/20 shadow-glow bg-brightGray/50 overflow-hidden relative"
            style={{
          ...
          >
            ...
            <CardContent className="p-12 text-center relative z-10">
              <div className="flex items-center justify-center gap-2 mb-6">
                ...
                <span className="text-brightGray/80 font-medium text-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                <Button
                  size="lg"
                  className="bg-carolinaBlue text-brightGray hover:bg-carolinaBlue/90 text-lg px-10 py-4 h-auto font-semibold shadow-card"
                >
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-carolinaBlue/50 text-brightGray hover:bg-carolinaBlue/10 text-lg px-10 py-4 h-auto font-semibold"
                >
                  Learn More
                </Button>
              </div>
              ...
              <div className="pt-6 border-t border-carolinaBlue/20">
                <p className="text-brightGray/80 text-sm mb-3">
                ...
                <p className="text-brightGray/60 text-xs mt-2">
                  Connect with trained mental health professionals
                </p>
              </div>
            </CardContent>
          </Card>
